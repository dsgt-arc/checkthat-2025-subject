...
def main(pred_path, gold_path) -> None:


    whole_data = validate_files(pred_path, gold_path)
...
if __name__ == '__main__':
    pred_path = 'data/raw_data/english/base_pred_lan.tsv'
    gold_path = 'data/raw_data/english/dev_test_en.tsv'
