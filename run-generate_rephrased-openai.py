...
def main():
    ...
    user_template = (
        ...
        "Rewrite (paraphrase) the sentence in a new way without losing its meaning "
        "and while keeping it classified as {label}.\n"
    ...
    out_df = pl.DataFrame(
    augmented_rows,
    schema=["sentence_id", "sentence", "label", "solved_conflict"]
    )
